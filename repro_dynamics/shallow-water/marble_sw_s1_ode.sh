...
run_dict={vorticity:'marble_sw_s1_vorticity_seed'$seed,height:'marble_sw_s1_height_seed'$seed}
# name='dyn_ddpV2_L'$latent_dim'_MoGChan'$grid_size'x'$grid_size_2'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_mlc'$meta_lr_code'_seed'$seed'_sw_dino_sub'$sub_tr
# id='dyn_ddpV2_L'$latent_dim'_MoGChan'$grid_size'x'$grid_size_2'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_mlc'$meta_lr_code'_seed'$seed'_sw_dino_sub'$sub_tr
name='dyn_marble_sw_s1_seed'$seed
