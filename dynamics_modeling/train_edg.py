...
from coral.utils.models.load_inr import create_inr_instance, load_inr_model_edg
from coral.utils.models.get_inr_reconstructions import get_reconstructions
from coral.utils.data.load_modulations import load_dynamics_modulations_edg
...
def main(cfg: DictConfig) -> None:
    ...
    if load_run_name is not None:
        inr, alpha, t_code = load_inr_model_edg(
            root_dir / "inr",
            load_run_name,
            data_to_encode,
            input_dim=input_dim,
        ...
        modulations = load_dynamics_modulations_edg(
            trainset,
            trainset_extra,
            testset,
            inr,
