...
from coral.utils.models.load_inr import create_inr_instance, load_inr_model_enc
from coral.utils.models.get_inr_reconstructions import get_reconstructions
from coral.utils.data.load_modulations import load_dynamics_modulations_enc
...
def main(cfg: DictConfig) -> None:
    ...
    if load_run_name is not None:
        ...
        modulations = load_dynamics_modulations_enc(
            trainset,
            trainset_extra,
            testset,
            inr,
