...
from coral.utils.models.scheduling import memory_ode_scheduling
...
from coral.mamba import DerivativeMamba 
...
from dynamics_modeling.eval_memory import batch_eval_loop
...
def main(cfg: DictConfig) -> None:
    ...
    model = DerivativeMamba(input_dim=c*z_train.shape[1], d_model=c*z_train.shape[1], d_state=d_state, n_layer=depth).cuda()
    print(model)
    ...
    for step in range(epochs):
        ...
        for substep, (images, modulations, coords, idx) in enumerate(train_loader):
            ...
            z_pred = memory_ode_scheduling(odeint, model, modulations, timestamps_train, epsilon_t)
