...
evaluate=True 
checkpoint_path='/cluster/home3/whh/workspace/pinn/exp_nvme4a/wandb/navier-stokes-nms-f40-64-wonorm/model/dyn2_metacode+grid32_woscale_wf_r3_first40_T64-wonorm_gridratio0.4_step3_bs128_lr1e-2_5k.pt'
...
run_name='metacode+grid'$grid_size'_woscale_wf_r3_first40_T64-wonorm_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
name='evaluate_npe_dyn2_metacode+grid'$grid_size'_woscale_wf_r3_first40_T64-wonorm_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='evaluate_npe_dyn2_metacode+grid'$grid_size'_woscale_wf_r3_first40_T64-wonorm_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
