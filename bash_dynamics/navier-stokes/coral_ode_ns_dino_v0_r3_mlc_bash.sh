...
CUDA_VISIBLE_DEVICES=0, bash /cluster/home1/whh/new_repo/coral/bash_dynamics/navier-stokes/coral_ode_ns_dino_v0_r3_mlc.sh 4 0.2 0.2 64 10 123 0.0 &
sleep 5s 

CUDA_VISIBLE_DEVICES=1, bash /cluster/home1/whh/new_repo/coral/bash_dynamics/navier-stokes/coral_ode_ns_dino_v0_r3_mlc.sh 4 0.2 0.2 64 10 124 0.0 &
sleep 5s 


CUDA_VISIBLE_DEVICES=2, bash /cluster/home1/whh/new_repo/coral/bash_dynamics/navier-stokes/coral_ode_ns_dino_v0_r3_mlc.sh 4 0.2 0.2 64 10 125 0.0 &
sleep 5s 
