...
name='dyn_hippo_wf_r3_last40_T64_wonorm_'$hippo_n'_'$memory_size
id='dyn_hippo_S256_wf_r3_last40_T64_wonorm_'$hippo_n'_'$memory_size
python3 dynamics_modeling/train_hippo.py "data.dir=$dir" "data.sub_from=$sub_from" "data.same_grid=$same_grid" "data.dataset_name=$dataset_name" "dynamics.hippo_n=$hippo_n" "dynamics.memory_size=$memory_size" "dynamics.width=$width" "dynamics.depth=$depth" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te" "optim.epochs=$epochs" "data.seq_inter_len=$seq_inter_len" "data.seq_extra_len=$seq_extra_len" "optim.batch_size=$batch_size" "optim.lr=$lr"  "dynamics.teacher_forcing_update=$teacher_forcing_update" "inr.run_name=$run_name" "wandb.name=$name" "wandb.id=$id"
