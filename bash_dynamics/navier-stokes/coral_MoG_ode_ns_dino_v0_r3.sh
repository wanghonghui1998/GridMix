...
run_name='ddp_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_256sub'$1'_'$2'_'$3
name='full_dyn_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_256sub'$1'_'$2'_'$3
id='full_dyn_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_256sub'$1'_'$2'_'$3
