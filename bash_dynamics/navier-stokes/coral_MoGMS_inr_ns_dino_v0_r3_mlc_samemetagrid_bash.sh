...
CUDA_VISIBLE_DEVICES=3, bash /cluster/home1/whh/new_repo/coral/bash_dynamics/navier-stokes/coral_MoGMS_inr_ns_dino_v0_r3_mlc_samemetagrid.sh 1 4 4 8 1.415 32 1e-2 1e-1 0.0 123 0.4 
# sleep 5s 
