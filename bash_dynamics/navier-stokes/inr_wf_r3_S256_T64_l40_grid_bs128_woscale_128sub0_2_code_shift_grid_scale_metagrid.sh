...
model_type='siren_code_shift_grid_scale'
same_grid=True
sub_from=2
sub_tr=0.2
sub_te=0.2
...
name='2metascodeshift+gridscale'$grid_size'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='2metascodeshift+gridscale'$grid_size'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
