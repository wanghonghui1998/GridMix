...
run_name='metaSG_MoGChanV2'$grid_size'_'$grid_base'_c'$grid_init_channel'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
name='dyn_metaSG_MoGChanV2'$grid_size'_'$grid_base'_c'$grid_init_channel'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='dyn_S256_metaSG_MoGChanV2'$grid_size'_'$grid_base'_c'$grid_init_channel'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
