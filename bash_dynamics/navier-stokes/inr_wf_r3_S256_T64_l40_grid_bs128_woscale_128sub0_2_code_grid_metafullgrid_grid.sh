...
meta_part_grid=True
name='metaFGcode+grid'$grid_size'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='metaFGcode+grid'$grid_size'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
