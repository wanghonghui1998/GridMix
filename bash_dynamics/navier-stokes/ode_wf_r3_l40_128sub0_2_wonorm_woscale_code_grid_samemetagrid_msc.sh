...
run_name='metaSGcode+grid'$grid_size'_msc'$num_scales'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
name='dynnpc_metaSGcode+grid'$grid_size'_msc'$num_scales'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='dynnpc_metaSGcode+grid'$grid_size'_msc'$num_scales'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
