...
name='ddp_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_mlc'$meta_lr_code'_seed'$seed'_256sub'$1'_'$2'_'$3
id='ddp_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_mlc'$meta_lr_code'_seed'$seed'_256sub'$1'_'$2'_'$3
