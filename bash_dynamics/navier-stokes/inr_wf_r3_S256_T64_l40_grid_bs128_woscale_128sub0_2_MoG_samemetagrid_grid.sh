...
name='metaSG_MoG'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='metaSG_MoG'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
