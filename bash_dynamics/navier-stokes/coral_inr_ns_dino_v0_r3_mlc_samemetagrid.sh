...
name='metaSG'$grid_ratio'_coral_mlc'$meta_lr_code'_bs'$batch_size'_w0'$w0'_seed'$seed'_ns_dino_v0_r3_256sub'$1'_'$2'_'$3
id='metaSG'$grid_ratio'_coral_mlc'$meta_lr_code'_bs'$batch_size'_w0'$w0'_seed'$seed'_ns_dino_v0_r3_256sub'$1'_'$2'_'$3
python3 inr/inr_metagrid.py "optim.meta_same_grid=$meta_same_grid" "optim.grid_ratio=$grid_ratio" "optim.meta_lr_code=$meta_lr_code" "inr.w0=$w0" "data.seed=$seed" "data.dir=$dir" "data.sub_from=$sub_from" "data.same_grid=$same_grid" "data.dataset_name=$dataset_name" "inr.model_type=$model_type" "data.seq_inter_len=$seq_inter_len" "data.seq_extra_len=$seq_extra_len" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te" "optim.lr_inr=$lr_inr" "inr.depth=$depth" "inr.latent_dim=$latent_dim" "inr.hidden_dim=$hidden_dim" "optim.batch_size=$batch_size" "optim.epochs=$epochs" "wandb.saved_checkpoint=$saved_checkpoint" "wandb.name=$name" "wandb.id=$id" #"wandb.dir=$dir" "wandb.checkpoint_path=$checkpoint_path"
