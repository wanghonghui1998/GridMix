...
srun -p A100 -w node09 -J dino -n2 --gres gpu:2 bash /cluster/home1/whh/new_repo/coral/bash_dynamics/navier-stokes/coral_inr_ns_dino_v0_r3_ddp.sh 1 2 2 29051 
# sleep 5s 
