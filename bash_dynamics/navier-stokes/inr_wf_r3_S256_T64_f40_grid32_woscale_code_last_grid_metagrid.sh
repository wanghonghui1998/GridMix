...
model_type='siren_code_last_grid'
same_grid=True
sub_from=1
sub_tr=4
sub_te=4
...
name='2metacode+lastgrid'$grid_size'_woscale_wf_r3_first40_T64-wonorm_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='2metacode+lastgrid'$grid_size'_woscale_wf_r3_first40_T64-wonorm_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
