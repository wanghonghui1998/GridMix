...
name='3metaSG'$grid_ratio'_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_mlc'$meta_lr_code'_w0'$w0'_seed'$seed'_256sub'$1'_'$2'_'$3
id='3metaSG'$grid_ratio'_MoGChan'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_alpha'$lr_code'_mlc'$meta_lr_code'_w0'$w0'_seed'$seed'_256sub'$1'_'$2'_'$3
