...
gaussian_padding=1
gaussian_sigma=$4
name='metaSGgrid'$grid_size'_ssgb'$num_scales'_'$gaussian_sigma'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='metaSGgrid'$grid_size'_ssgb'$num_scales'_'$gaussian_sigma'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
