...
# run-20240613_025023-dyn_metacode+grid32_woscale_128sub0_2_gridratio0.4_step3_bs128_lr1e-2
...
run_name='metagrid'$grid_size'_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr1e-2'
name='eval_dyn_npc_metagrid'$grid_size'_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr1e-2'
id='eval_npc_metagrid'$grid_size'_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr1e-2'
