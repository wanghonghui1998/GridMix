...
name='hashenc'$n_levels'_'$base_resolution'_'$per_level_scale'_F'$n_features_per_level'_wf_r3_last40_T64-wonorm2'
id='hashenc'$n_levels'_'$base_resolution'_'$per_level_scale'_F'$n_features_per_level'_wf_r3_S256_last40_T64-wonorm2'
