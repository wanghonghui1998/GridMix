...
lr_grid=$6
share_code=$7
name='2metaSG_Code'$share_code'+MoG'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='2metaSG_Code'$share_code'+MoG'$grid_size'_'$grid_base'_'$share_grid'_'$grid_sum'_'$lr_grid'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
python3 inr/inr_metagrid.py "inr.share_code=$share_code" "inr.grid_sum=$grid_sum" "inr.share_grid=$share_grid" "inr.grid_base=$grid_base" "optim.lr_grid=$lr_grid" "optim.meta_same_grid=$meta_same_grid" "optim.lr_code=$lr_code" "optim.test_inner_steps=$inner_steps" "optim.inner_steps=$inner_steps" "optim.grid_ratio=$grid_ratio" "inr.use_norm=$use_norm" "inr.grid_size=$grid_size" "inr.modulate_scale=$modulate_scale" "data.dir=$dir" "data.sub_from=$sub_from" "data.same_grid=$same_grid" "data.dataset_name=$dataset_name" "inr.model_type=$model_type" "data.seq_inter_len=$seq_inter_len" "data.seq_extra_len=$seq_extra_len" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te" "optim.lr_inr=$lr_inr" "inr.depth=$depth" "inr.latent_dim=$latent_dim" "inr.hidden_dim=$hidden_dim" "optim.batch_size=$batch_size" "optim.epochs=$epochs" "wandb.saved_checkpoint=$saved_checkpoint" "wandb.name=$name" "wandb.id=$id" #"wandb.dir=$dir" "wandb.checkpoint_path=$checkpoint_path"
