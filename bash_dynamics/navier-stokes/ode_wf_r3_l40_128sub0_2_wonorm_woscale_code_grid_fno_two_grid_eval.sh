...
evaluate=True
checkpoint_path='/cluster/home3/whh/workspace/pinn/exp_nvme4a/wandb/navier-stokes-nms-40-64-wonorm/model/dyn_metacode+gridfno32_woscale_128sub0_2_gridratio0.4_step3_bs128_lr1e-2_ck.pt'
...
name='eval_truegrid_dyn_metacode+gridfno'$grid_size'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
id='eval_truegrid_dyn_metacode+gridfno'$grid_size'_woscale_128sub0_2_gridratio'$grid_ratio'_step'$inner_steps'_bs128_lr'$lr_code
